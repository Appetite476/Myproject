    ...
    ui(new Ui::DBInfoSet)
{
    ...
    ui->dbHostName->setText("rm-2vc769uw6e4v69f95do.mysql.cn-chengdu.rds.aliyuncs.com");
    ui->dbName->setText("wjy");
    ui->dbUser->setText("wjy_aiyaoxian");
    ui->dbPasswd->setText("Wjy@200125");
